...
extern control::ConstrainedPID::PID_Init_t steering_motor_theta_pid_init;
extern control::ConstrainedPID::PID_Init_t steering_motor_omega_pid_init;

extern control::ConstrainedPID::PID_Init_t flywheel_pid_init;
...
void Shoot_Mode_SINGLE(float target, int num = 1);
void Shoot_Mode_BURST(float target, int num = 1);
