...
void init_gimbal() {
    ...
    pitch_motor->ReInitPID(pitch_theta_pid_init, driver::MotorCANBase::ANGEL_LOOP_CONTROL);
    ...
    pitch_motor->ReInitPID(pitch_omega_pid_init, driver::MotorCANBase::SPEED_LOOP_CONTROL);
    ...
    yaw_motor->ReInitPID(yaw_theta_pid_init, driver::MotorCANBase::ANGEL_LOOP_CONTROL);
    ...
    yaw_motor->ReInitPID(yaw_omega_pid_init, driver::MotorCANBase::SPEED_LOOP_CONTROL);
