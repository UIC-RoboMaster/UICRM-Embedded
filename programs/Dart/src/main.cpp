...
void RM_RTOS_Init() {
    ...
    flywheel_motor1->ReInitPID(omega_pid_init, driver::MotorCANBase::SPEED_LOOP_CONTROL);
    flywheel_motor2->ReInitPID(omega_pid_init, driver::MotorCANBase::SPEED_LOOP_CONTROL);
    flywheel_motor3->ReInitPID(omega_pid_init, driver::MotorCANBase::SPEED_LOOP_CONTROL);
    flywheel_motor4->ReInitPID(omega_pid_init, driver::MotorCANBase::SPEED_LOOP_CONTROL);
    flywheel_motor1->SetMode(driver::MotorCANBase::SPEED_LOOP_CONTROL |
                             driver::MotorCANBase::REVERSE_MOTOR_OPERATE);
    flywheel_motor2->SetMode(driver::MotorCANBase::SPEED_LOOP_CONTROL);
    flywheel_motor3->SetMode(driver::MotorCANBase::SPEED_LOOP_CONTROL |
                             driver::MotorCANBase::REVERSE_MOTOR_OPERATE);
    flywheel_motor4->SetMode(driver::MotorCANBase::SPEED_LOOP_CONTROL);
    ...
    pitch_motor->ReInitPID(motor_3508_omega_pid_init, driver::MotorCANBase::SPEED_LOOP_CONTROL);
    pitch_motor->SetMode(driver::MotorCANBase::SPEED_LOOP_CONTROL);

    putter_motor->SetTransmissionRatio(19);
    putter_motor->ReInitPID(motor_3508_omega_pid_init, driver::MotorCANBase::SPEED_LOOP_CONTROL);
    putter_motor->SetMode(driver::MotorCANBase::SPEED_LOOP_CONTROL);
