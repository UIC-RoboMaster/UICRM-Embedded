...
void init_shoot() {
    ...
    flywheel_left->ReInitPID(omega_pid_init, driver::MotorCANBase::SPEED_LOOP_CONTROL);
    flywheel_right->ReInitPID(omega_pid_init, driver::MotorCANBase::SPEED_LOOP_CONTROL);
    flywheel_left->SetMode(driver::MotorCANBase::SPEED_LOOP_CONTROL);
    flywheel_right->SetMode(driver::MotorCANBase::SPEED_LOOP_CONTROL |
    ...
    steering_motor->ReInitPID(steering_theta_pid_init, driver::MotorCANBase::ANGEL_LOOP_CONTROL);
    ...
    steering_motor->ReInitPID(steering_omega_pid_init, driver::MotorCANBase::SPEED_LOOP_CONTROL);
    steering_motor->SetMode(driver::MotorCANBase::ANGEL_LOOP_CONTROL |
