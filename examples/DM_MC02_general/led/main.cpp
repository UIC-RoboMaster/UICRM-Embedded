...
void RM_RTOS_Init(void) {
    ...
    display::ws2812_init_t ws2812_init = {
        .spi = spi,
        .led_num = 1,
        .high_level = WS2812_SPI_6M_HighLevel,
        .low_level = WS2812_SPI_6M_LowLevel,
    };
    led = new display::WS2812(ws2812_init);
}
