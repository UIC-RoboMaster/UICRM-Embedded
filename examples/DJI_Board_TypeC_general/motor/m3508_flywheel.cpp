...
void RM_RTOS_Init() {
    ...
    motor3 = new driver::Motor3508(can2, 0x203);
    motor4 = new driver::Motor3508(can2, 0x204);

    motor1->SetTransmissionRatio(1);
    motor2->SetTransmissionRatio(1);
    motor3->SetTransmissionRatio(1);
    motor4->SetTransmissionRatio(1);
...
void RM_RTOS_Default_Task(const void* args) {
    ...
    while (true) {
        ...
        if (key.Read() == 0) {
            ...
            if (current == 0) {
                current = 10000;
                motor1->SetTarget(120 * 2 * PI);
                motor2->SetTarget(120 * 2 * PI);
                motor3->SetTarget(120 * 2 * PI);
                motor4->SetTarget(120 * 2 * PI);
            } else {
                current = 0;
                motor1->SetTarget(0);
                motor2->SetTarget(0);
