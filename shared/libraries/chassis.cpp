...
Chassis::Chassis(const chassis_t chassis) : pids_() {
  ...
  case CHASSIS_MECANUM_WHEEL: {
    ...
    pids_[FourWheel::front_left].Reinit(pid_param, motor_max_iout,
                                        motor_max_out);
    pids_[FourWheel::front_right].Reinit(pid_param, motor_max_iout,
                                         motor_max_out);
    pids_[FourWheel::back_left].Reinit(pid_param, motor_max_iout,
                                       motor_max_out);
    pids_[FourWheel::back_right].Reinit(pid_param, motor_max_iout,
                                        motor_max_out);
...
void Chassis::SetSpeed(const float x_speed, const float y_speed,
...
void Chassis::Update(bool power_limit_on, float power_limit,
  ...
  case CHASSIS_MECANUM_WHEEL: {
    ...
    PID_output[FourWheel::front_left] =
        pids_[FourWheel::front_left].ComputeOutput(
            motors_[FourWheel::front_left]->GetOmegaDelta(
                speeds_[FourWheel::front_left]));
    PID_output[FourWheel::back_left] =
        pids_[FourWheel::back_left].ComputeOutput(
            motors_[FourWheel::back_left]->GetOmegaDelta(
                speeds_[FourWheel::back_left]));
    PID_output[FourWheel::front_right] =
        pids_[FourWheel::front_right].ComputeOutput(
            motors_[FourWheel::front_right]->GetOmegaDelta(
                speeds_[FourWheel::front_right]));
    PID_output[FourWheel::back_right] =
        pids_[FourWheel::back_right].ComputeOutput(
            motors_[FourWheel::back_right]->GetOmegaDelta(
