...
namespace control {
    ...
    class Pose {
      public:
         ...
         *  @note: this error gets larger as ROLL gets larger. When ROLL get close to +/-90 deg,
         *this value is not usable.
         **/
        float GetPitch(void);

        /** @description: read estimated roll in RAD
         *  @note: this error gets larger as PITCH gets larger. When PITCH get close to +/-90 deg,
         *this value is not usable.
         **/
        float GetRoll(void);
