...
namespace control {
     ...
     */
    typedef struct {
        driver::CanMotorBase* pitch_motor; /* pitch motor instance */
        driver::CanMotorBase* yaw_motor;   /* yaw motor instance   */
    ...
    class Gimbal {
      ...
      private:
        // acquired from user
        driver::CanMotorBase* pitch_motor_ = nullptr;
        driver::CanMotorBase* yaw_motor_ = nullptr;
