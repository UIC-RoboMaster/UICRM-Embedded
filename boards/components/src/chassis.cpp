...
namespace control {
    ...
    void Chassis::ApplyPowerLimit() {
        ...
        // 当裁判系统 buffer 剩余较多时，允许电机适当超功率，当裁判系统 buffer 剩余较少时，大幅度限制电机功率来避免估算误差
        max_current = max_current * linear_interpolation<int>(40, 100, 80, 130, power_limit_.buffer_percent) / 100;
