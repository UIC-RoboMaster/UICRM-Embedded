...
namespace bsp {
    ...
    class CAN {
      public:
         ...
         * @brief bsp CAN实例构造函数
         *
         * @param hfdcan     HAL can 句柄
         * @param start_id rx的最小stdid，当前已经弃用
         * @param is_master
         * 是否为主控端，此项在hfdcan为hfdcan1的时候需要设置为true，其他时候设置为false。
         */
        /**
         ...
         *
         * @param hfdcan  HAL can handle to be checked
         *
         ...
         * @note should not be called explicitly form the application side
         */
        void RxExtendCallback(FDCAN_RxHeaderTypeDef header, uint8_t* data);
