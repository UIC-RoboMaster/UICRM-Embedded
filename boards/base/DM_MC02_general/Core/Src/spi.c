...
void HAL_SPI_MspInit(SPI_HandleTypeDef* spiHandle)
{
  ...
  /* USER CODE END SPI1_MspInit 0 */
    ...
    */
    ...
    /* SPI1 DMA Init */
    /* SPI1_TX Init */
    hdma_spi1_tx.Instance = DMA2_Stream7;
    ...
    /* SPI1_RX Init */
    hdma_spi1_rx.Instance = DMA2_Stream6;
  ...
  */
    ...
    */
    ...
    GPIO_InitStruct.Pin = WS2812B_SPI_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
    GPIO_InitStruct.Alternate = GPIO_AF8_SPI6;
    HAL_GPIO_Init(WS2812B_SPI_GPIO_Port, &GPIO_InitStruct);
...
void HAL_SPI_MspDeInit(SPI_HandleTypeDef* spiHandle)
{
  ...
  /* USER CODE END SPI6_MspDeInit 0 */
    ...
    PA7     ------> SPI6_MOSI
    */
    HAL_GPIO_DeInit(GPIOA, GPIO_PIN_5|WS2812B_SPI_Pin);
