...
namespace communication {
    ...
    class Protocol : public driver::ConnectionDriver {
      public:
        ...
        /**
         * @brief Generate the package to be sent according to the command and save to the internal
         * bufferTx.\n The payload is generated by ProcessDataTx, which is a pure virtual function
         * and should be implemented in the derived class. \n
         *
         * @param cmd_id    command id
         * @return package that includes a pointer to the internal bufferTx and the length of the
         * data in bufferTx
         */
