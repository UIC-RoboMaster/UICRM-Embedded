...
namespace communication {
    ...
    class Protocol : public driver::ConnectionDriver {
      public:
        /**
         * @brief Should be called when a new package is received. \n
         * Will verify the package and call ProcessDataRx to process subcommands if valid.
         *
         * @param package the package that is received from referee system
         * @return true for success; false for failure
         */
        bool Receive(package_t package);

        /**
         * @brief Generate the package to be sent according to the command and save to the internal bufferTx.\n
         * The payload is generated by ProcessDataTx, which is a pure virtual function and should be implemented in the derived class. \n
         *
         * @param cmd_id    command id
         * @return package that includes a pointer to the internal bufferTx and the length of the data in bufferTx
         */
        virtual package_t Transmit(int cmd_id);
    ...
    class Referee : public UARTProtocol {
      public:
        ...
        remote::vt13_packet_t vt13_packet{};
